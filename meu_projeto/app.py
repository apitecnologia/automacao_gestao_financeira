...
# --- O restante do seu código (todas as suas rotas @app.route) continua aqui sem alterações ---
# (Cole o restante das suas funções Flask aqui)
...
def register():
    # Esta lógica permite que o primeiro usuário seja admin. Funciona perfeitamente na Render.
...
# (Continue com o resto das suas rotas: clientes, pedidos, gestao_financeira, etc.)
...
def gestao_financeira():
    ...
    for parcela in parcelas:
        ...
        fluxo_caixa_mensal[chave_mes]['parcelas'].append({
            ...
            'valor': parcela.valor,
            'forma_pagamento': parcela.pedido.forma_pagamento,
